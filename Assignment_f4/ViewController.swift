...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, DestinationDelegate, MFMailComposeViewControllerDelegate {
    ...
    var manners : [Manners] = [
        Manners(name: "Sneezing", description: "It is polite to sneeze into your elbow and not at people without covering your mouth.", picture: UIImage(named: "sneezing")!),
        Manners(name: "Shoes", description: "It is polite to take your shoes off in some people's house unless they say that they do not mind it.", picture: UIImage(named: "shoes")!),
        Manners(name: "Chewing", description: "It is polite to chew with your mouth closed and not make too much noise when chewing.", picture: UIImage(named: "chewing")!),
        Manners(name: "Knocking", description: "It is polite to knock on someone's door before walking in- especially if you are not too familiar with them.", picture: UIImage(named: "knocking")!),
        Manners(name: "Holding the Door", description: "It is polite to hold the door open to people walking in behind you rather than slamming it in their face.", picture: UIImage(named: "holding_door")!),
        Manners(name: "Language", description: "It is polite to refrain from using curse words as many people think it is offensive.", picture: UIImage(named: "curse_words")!),
        Manners(name: "Coughing", description: "It is polite to cough into one's elbow and not at other people as this can spread germs.", picture: UIImage(named: "coughing")!),
        Manners(name: "Talking in the Library", description: "It is polite to keep your voice at a whisper level when talking in the library.", picture: UIImage(named: "talking")!)]
